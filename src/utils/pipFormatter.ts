...
export function formatPipPrice(price: number, decimals: number, isForexPair: boolean = false): PipPriceParts {
  ...
  if (isForexPair && decimals >= 4) {
  ...
  } else if (isForexPair && decimals === 3) {
    ...
    // Commodities, Metals, Crypto, Stocks, Indices (e.g. 4304.185, 75892.00)
